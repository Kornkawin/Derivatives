# -*- coding: utf-8 -*-
"""
Created on Fri Apr 26 14:25:47 2019
...
def simulate_gbm():
    ...
    # stock price paths
    rand = np.random.standard_normal((M, I)) # random numbers I path with M timesteps
...
def print_statistics(data):
    ...
    print("---------------------------------------------")
    print("Mean of Daily Log Returns {}".format(np.mean(data['returns'])))
    print("Std of Daily Log Returns {}".format(np.std(data['returns'])))
    print("Mean of Annua. Log Returns {}".format(np.mean(data['returns']) * 252))
    print("Std of Annua. Log Returns {}".format(np.std(data['returns']) * math.sqrt(252)))
    print("---------------------------------------------")
    print("Skew of Sample Log Returns {}".format(scs.skew(data['returns'])))
    print("Skew Normal Test p-value {}".format(scs.skewtest(data['returns'])[1]))
    print("---------------------------------------------")
    print("Kurt of Sample Log Returns {}".format(scs.kurtosis(data['returns'])))
    print("Kurt Normal Test p-value {}".format(scs.kurtosistest(data['returns'])[1]))
    print("---------------------------------------------")
    print("Normal Test p-value {}".format(scs.normaltest(data['returns'])[1]))
    print("---------------------------------------------")
    print("Realized Volatility {}".format(data['rea_vol'].iloc[-1]))
    print("Realized Variance {}".format(data['rea_var'].iloc[-1]))
